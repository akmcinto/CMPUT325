        ...
        (t
            (let ( (f (car E))  (arg (cdr E)) )
                (cond
                    ...
                    ((eq f '<)  (< (fl-interp (car arg) P) (fl-interp (cadr arg) P)))
                    ((eq f '=)  (= (fl-interp (car arg) P) (fl-interp (cadr arg) P)))
                    ((eq f 'and)  (not (null (and (fl-interp (car arg) P) (fl-interp (cadr arg) P)))))
                    ((eq f 'or)  (not (null (or (fl-interp (car arg) P) (fl-interp (cadr arg) P)))))
